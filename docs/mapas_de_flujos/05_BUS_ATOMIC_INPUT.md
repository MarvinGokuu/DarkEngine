...
graph TD
    ...
    subgraph game_thread [Hilo Lógico del Motor]
        B -->|Lectura Lock-Free| C[DarkInputSystem]
...
## Leyenda Técnica:
*   **Ring Buffer Atómico:** Un arreglo circular en memoria que permite a un hilo escribir (OS) y a otro leer (Motor) al mismo tiempo sin colisionar ni trabarse. Funciona bajo el principio de semántica de memoria *Volatile*.
